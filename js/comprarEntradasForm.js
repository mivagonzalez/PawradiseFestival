/* when jQuery laods */
    $(document).ready(function() {
      ...
      $('#back').on('click', function() {
		...
		$('li').find('a[data-toggle="tab"]').removeClass('activeOption');
    ...
    render = function() {
      ...
      if (total_tickets > 0) {
        $('#continuarButton').prop('disabled', false);
      } else {
        $('#continuarButton').prop('disabled', true);
      }
    }
    ...
    var insert = function(num) {
      ...
      "<div class='row'>"+
        ...
        "<div class='col-xs-5'><input type='text' class='form-control' name='names[]' placeholder='Nombre y Apellido Completo' required></div>"+
